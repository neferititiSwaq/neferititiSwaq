...
<!-- NSK-AGENT-START -->
    ...
    ">
        ...
        <p style="font-style: italic; opacity: 0.9; margin-bottom: 1.5rem;">"Maria is an enthusiastic and entrepreneurial learner, actively building various web-based projects with a focus on personal branding and social impact."</p>
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
            ...
            <span class='badge'>JavaScript</span><span class='badge'>HTML</span><span class='badge'>Front-end Development</span>
        </div>
        ...
        <div style="margin-top: 1.5rem; font-size: 0.85rem; opacity: 0.8; background-color: #ffffff; padding: 0.8rem; border-radius: 8px; border-left: 3px solid #0969da;">
            <strong>Fun Fact:</strong> Despite being an avid learner, Maria is already envisioning ambitious projects, including 'Digital Scaffolding for Africa's Sovereign Economic Future'.
        </div>

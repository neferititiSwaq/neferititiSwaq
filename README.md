...
<!-- NSK-AGENT-START -->
    ...
    ">
        ...
        <p style="font-style: italic; opacity: 0.9; margin-bottom: 1.5rem;">"Maria is an ambitious and detail-oriented learner with a keen interest in web development, branding, and projects aiming for economic impact."</p>
        ...
        <div style="margin-top: 1.5rem; font-size: 0.85rem; opacity: 0.8; background-color: #ffffff; padding: 0.8rem; border-radius: 8px; border-left: 3px solid #0969da;">
            <strong>Fun Fact:</strong> Maria is developing a personal brand or initiative, 'NSK,' which she ambitiously describes as 'Digital Scaffolding for Africa's Sovereign Economic Future.'
        </div>

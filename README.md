...
<!-- NSK-AGENT-START -->
    ...
    ">
        ...
        <p style="font-style: italic; opacity: 0.9; margin-bottom: 1.5rem;">"Maria is an aspiring devpreneur focused on learning and building projects with a strong emphasis on social and economic impact."</p>
        ...
        <div style="margin-top: 1.5rem; font-size: 0.85rem; opacity: 0.8; background-color: #ffffff; padding: 0.8rem; border-radius: 8px; border-left: 3px solid #0969da;">
            <strong>Fun Fact:</strong> She's an aspiring devpreneur whose projects range from envisioning Africa's economic future to creating her own clothing brand.
        </div>

...
<!-- NSK-AGENT-START -->
    ...
    ">
        ...
        <p style="font-style: italic; opacity: 0.9; margin-bottom: 1.5rem;">"Maria is a proactive and entrepreneurial learner, eager to bring various web-based ideas and brands to life through development."</p>
        ...
        <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
            ...
            <span class='badge'>Web Development</span><span class='badge'>JavaScript</span><span class='badge'>HTML</span>
        </div>
        ...
        <div style="margin-top: 1.5rem; font-size: 0.85rem; opacity: 0.8; background-color: #ffffff; padding: 0.8rem; border-radius: 8px; border-left: 3px solid #0969da;">
            <strong>Fun Fact:</strong> Maria seems to be passionate about a recurring 'NSK' initiative, envisioning it as 'Digital Scaffolding for Africa's Sovereign Economic Future'.
        </div>

...
<!-- NSK-AGENT-START -->
    ...
    ">
        ...
        <p style="font-style: italic; opacity: 0.9; margin-bottom: 1.5rem;">"Maria is a driven and entrepreneurial individual, passionate about learning and building web projects with a vision for future-oriented concepts."</p>
        ...
        <div style="margin-top: 1.5rem; font-size: 0.85rem; opacity: 0.8; background-color: #ffffff; padding: 0.8rem; border-radius: 8px; border-left: 3px solid #0969da;">
            <strong>Fun Fact:</strong> Maria is an aspiring 'devpreneur' with a vision for Africa's economic future, as hinted by her project descriptions.
        </div>
